...
<head>
    ...
    <title>Edit Course - ITE311-BUHISAN</title>
                ...
                <form action="<?= site_url('admin/courses/update/' . $course['id']) ?>" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="course_code" name="course_code" value="<?= esc($course['course_code']) ?>" required
                                   class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                        </div>
                        ...
                        <div>
                            ...
                            <select id="instructor_id" name="instructor_id" required
                                ...
                                <?php foreach ($teachers as $teacher): ?>
                                    <option value="<?= esc($teacher['id']) ?>" <?= ($course['instructor_id'] == $teacher['id']) ? 'selected' : '' ?>>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" required
                                      class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent resize-vertical"><?= esc($course['description']) ?></textarea>
                        </div>
